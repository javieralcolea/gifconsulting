...
<html lang="es">
	...
	<body>
		...
		<section>
			<fieldset id="campo4">
				<?php echo form_open('empresa/cambiaEmpresa'); ?>
					<h1>Nueva empresa</h1>
					<br>
					<table>
						<tr>
						...
						<tr>
							...
							<td><input type="text" name="usuario" value="<?php echo $Usuario_Empresa; ?>"></td>
							<td><label for="clave">Clave</label></td>
							<td><input type="text" name="clave" value="<?php echo $Clave_Empresa; ?>"></td>
						</tr>		
						<tr>
							<td><input type="submit" value="Aceptar" name="aceptar"></td>
							<?php echo form_close(); ?>
							<?php echo form_open('empresa/empresaBorra',array("onsubmit"=>"return confirm('Vas a eliminar esta empresa. \\n¿Estás seguro?')")); ?>
							<input type="hidden" name="neocif" value="<?php echo $CIF_Empresa; ?>">
							<td><input type="submit" value="Eliminar" name="borrar"></td>
							<?php echo form_close(); ?>
							<td><a href="<?php echo URL."empresa/todasLasEmpresas"; ?>" id='volver'>Volver</a></td>
						</tr>
					</table>
